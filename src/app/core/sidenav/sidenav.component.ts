...
export class SidenavComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.breadcrumbService.addFriendlyNameForRoute('/add_visit', "Material Icons");
    this.breadcrumbService.addFriendlyNameForRoute('/dashboard-v1', "Dashboard v1");
    this.breadcrumbService.addFriendlyNameForRoute('/visits', "Drag & Drop");
    this.breadcrumbService.addFriendlyNameForRoute('/editor', "WYSISYG Editor");
    this.breadcrumbService.addFriendlyNameForRoute('/leads', "leads");
