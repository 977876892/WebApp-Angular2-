...
// nav bars
    ...
    let icons = menu.addItem('Material Icons', 'grade', '/add_visit', 7);
    let dragAndDrop = menu.addItem('Drag & Drop', 'mouse', '/visits', 9);
    let editor = menu.addItem('WYSIWYG Editor', 'format_shapes', '/editor', 10, 'NEW', '#3F51B5');
    let leads = menu.addItem('leads', 'format_shapes', '/leads', 10, 'NEW', '#3F51B5');
    ...
    menu.addItem('Index', 'mail', '/apps/inbox', 1, '22', '#7986CC');
    ...
    menu.addSubItem(customPages, 'Login Page', '/', 1);
